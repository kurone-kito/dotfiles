...
| Critique-pass delegate              | Absent — C1 uses the per-agent Critique pass invocation table                                                                                                                                                                                                                                                                                                                                                                                                                             | Set `critiqueLoop.delegate.command` in `.github/idd/config.json`, plus optional `mode` (`fallback` default, `combined`, `on-success`, `never`) selecting when the per-agent mechanism also runs; see [Critique pass invocation](idd-workflow.md#critique-pass-invocation).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| User-global critique-pass delegate and telemetry hook | Absent — each fragment is only consulted when the matching repo-local key (`critiqueLoop.delegate` or `critiqueLoop.telemetryHook`) in `.github/idd/config.json` is entirely absent; a local runtime may inherit either one from `$XDG_CONFIG_HOME/idd-skill/config.json` (or `$HOME/.config/idd-skill/config.json`)                                                                                                                                                                                                                                                                    | Not a repository setting — it lives outside `.github/idd/config.json` in the operator's own home directory. Both the `critiqueLoop.delegate` and `critiqueLoop.telemetryHook` fragments are inherited from it, independently per key; see [User-global critique delegate default](idd-workflow.md#user-global-critique-delegate-default) and [User-global critique telemetry hook default](idd-workflow.md#user-global-critique-telemetry-hook-default). Repo-local policy remains authoritative for every other surface.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
