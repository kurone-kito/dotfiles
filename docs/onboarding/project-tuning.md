...
[Helper-assisted path](https://github.com/kurone-kito/idd-skill/blob/v0.12.2/idd-template/ONBOARDING.md#helper-assisted-path)'s
...
[Step 5 — Update agent entry files](https://github.com/kurone-kito/idd-skill/blob/v0.12.2/idd-template/ONBOARDING.md#step-5--update-agent-entry-files)
...
[`{{TRUSTED_MARKER_ACTOR}}`](https://github.com/kurone-kito/idd-skill/blob/c11c3642319b3283293e4e681861bf7899c32ed3/idd-template/docs/onboarding/placeholders.md)
...
[IDD label
names](https://github.com/kurone-kito/idd-skill/blob/c11c3642319b3283293e4e681861bf7899c32ed3/idd-template/docs/onboarding/policy-decisions.md#idd-label-names)
...
use (see
[Optional companion boundary](https://github.com/kurone-kito/idd-skill/blob/v0.12.2/idd-template/ONBOARDING.md#optional-companion-boundary)
