...
Write-Warning 'Windows administrator accounts: run & "$HOME\.local\bin\sync-openssh-authorized-keys.ps1" (elevated) to propagate these keys into administrators_authorized_keys; see docs/sshd-config-setup.md.'
