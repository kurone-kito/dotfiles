...
2. 在为此存储库做出贡献时，请首先通过
   [讨论](https://github.com/kurone-kito/dotfiles/discussions) 或任何其他方法
   与该存储库的所有者讨论您希望进行的更改，然后再进行更改。
3. 如果您的想法可以通过**小修复显示，请直接使用[拉取请求](https://github.com/kurone-kito/dotfiles/pulls)**。
...
6. 如果您的更改涉及脚本，请在提交前**运行测试套件**。
   有关命令和前提条件，请参阅
   [README 的测试部分](../README.md#testing)。
