...
| Active stale claim (≥ 12 h, other session) + matching local worktree is occupied or unreadable  | STOP — recover the local worktree or verify owner-resume / forced-handoff successor claim-id                                  |
